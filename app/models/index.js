...
db.warehouseChecks = require("./warehouseCheck.model")(mongoose);
db.quickPurchaseRequests = require("./quickPurchaseRequest.model")(mongoose);
db.quickStockReceipts = require("./quickStockReceipt.model")(mongoose);
db.invoiceEvents = require("./invoiceEvent.model")(mongoose);
module.exports = db;
